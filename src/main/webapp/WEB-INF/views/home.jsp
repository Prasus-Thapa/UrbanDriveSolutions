    ...
    <%@ taglib prefix="c" uri="jakarta.tags.core" %>
        ...
        <head>
            ...
            <meta name="description"
                content="Urban Drive Solutions — Nepal's premium vehicle rental platform. Browse 200+ curated vehicles." />
        ...
        <body>
                        ...
                        <c:choose>
                            <c:when test="${not empty sessionScope.loggedInUser}">
                                <a href="${pageContext.request.contextPath}/logout"
                                    class="btn btn-outline btn-md">Logout</a>
                            </c:when>
                            <c:otherwise>
                                <a href="${pageContext.request.contextPath}/login" class="btn btn-primary btn-md">Sign
                                    Up</a>
                            </c:otherwise>
                        </c:choose>
                    </div>
            ...
            <main>
                <section class="hero">
                    <video class="hero-video" id="heroVideo" autoplay muted playsinline>
                        <source src="${pageContext.request.contextPath}/static/img/bg-video.mp4" type="video/mp4" />
                    </video>
                    ...
                    <div class="hero-inner" id="heroContent">
                        ...
                        <p class="hero-desc">
                            Experience Nepal's most curated fleet of premium vehicles. From city commutes to mountain
                            escapes —
                        ...
                        <c:if test="${sessionScope.loggedInUser.role ne 'ADMIN'}">
                            <div
                                style="background:#fff; border:1px solid #e5e7eb; border-radius:1rem; padding:1.5rem; margin-top:2rem; box-shadow:0 2px 12px rgba(0,0,0,0.06);">
                                <p
                                    style="font-size:0.7rem; font-weight:700; letter-spacing:0.12em; text-transform:uppercase; color:#6b7280; margin-bottom:1rem;">
                                    Find Your Vehicle
                                </p>
                                <div style="display:flex; gap:1rem; flex-wrap:wrap; align-items:flex-end;">
                                    <div style="flex:1; min-width:120px;">
                                        <label for="homePickup"
                                            style="display:block; font-size:0.75rem; font-weight:600; margin-bottom:0.375rem; color:#111;">Pickup
                                            Date</label>
                                        <input id="homePickup" type="date" class="form-input"
                                            style="color:#111; background:#fff;" />
                                    </div>
                                    <div style="flex:1; min-width:120px;">
                                        <label for="homeReturn"
                                            style="display:block; font-size:0.75rem; font-weight:600; margin-bottom:0.375rem; color:#111;">Return
                                            Date</label>
                                        <input id="homeReturn" type="date" class="form-input"
                                            style="color:#111; background:#fff;" />
                                    </div>
                                    <button onclick="handleVehicleSearch()" class="btn btn-primary btn-lg"
                ...
                <section style="padding:4rem 0; background:#fff;">
                    <div style="max-width:1600px; margin:0 auto; padding:0 4rem;">
                        <div style="text-align:center; margin-bottom:2.5rem;">
                            <h2
                                style="font-family:'Space Grotesk',sans-serif; font-size:2rem; font-weight:800; letter-spacing:-0.03em;">
                                Our Vehicle Fleet</h2>
                            <p style="color:var(--n-500); margin-top:0.5rem; font-size:0.95rem;">Browse our curated
                                selection of premium vehicles ready for your next journey.</p>
                        </div>
                        ...
                        <c:choose>
                            <c:when test="${not empty featuredVehicles}">
                                <div style="position:relative;">
                                    <!-- Scrollable track -->
                                    <div id="vehicleSlider" style="display:flex; gap:1.25rem; overflow-x:auto; scroll-behavior:smooth;
                                    scrollbar-width:none; -ms-overflow-style:none; padding:0.5rem 0 1rem;">
                                        <c:forEach var="v" items="${featuredVehicles}" end="5">
                                            <div class="card" style="overflow:hidden; flex:0 0 360px; min-width:360px;">
                                                <div
                                                    style="background:var(--n-100); height:140px; display:flex; align-items:center; justify-content:center;">
                                                    <span class="material-symbols-outlined"
                                                        style="font-size:4rem; color:var(--n-300);">directions_car</span>
                                                </div>
                                                <div class="card-body">
                                                    <div
                                                        style="display:flex; justify-content:space-between; align-items:flex-start; gap:0.5rem; margin-bottom:0.5rem;">
                                                        <h3
                                                            style="font-family:'Space Grotesk',sans-serif; font-weight:700; font-size:1rem;">
                                                            ${v.brand} ${v.model}</h3>
                                                        <span
                                                            style="font-size:0.7rem; font-weight:600; background:var(--n-100); padding:0.2rem 0.6rem; border-radius:99px; white-space:nowrap; flex-shrink:0;">${v.vehicleType}</span>
                                                    </div>
                                                    <div
                                                        style="display:flex; gap:1rem; font-size:0.8rem; color:var(--n-500); margin-bottom:1rem;">
                                                        <span><span class="material-symbols-outlined"
                                                                style="font-size:0.9rem; vertical-align:middle;">person</span>
                                                            ${v.seats} seats</span>
                                                        <span><span class="material-symbols-outlined"
                                                                style="font-size:0.9rem; vertical-align:middle;">palette</span>
                                                            ${v.color}</span>
                                                    </div>
                                                    <div
                                                        style="display:flex; justify-content:space-between; align-items:center;">
                                                        <p style="font-weight:800; font-size:1.05rem;">Rs.
                                                            ${v.pricePerDay}<span
                                                                style="font-size:0.75rem; font-weight:400; color:var(--n-500);">/day</span>
                                                        </p>
                                    ...
                                    <!-- Prev arrow -->
                                    <button onclick="slideVehicles(-1)" aria-label="Previous" style="position:absolute; left:0; top:45%; transform:translateY(-50%); z-index:2;
                                       width:2.5rem; height:2.5rem; border-radius:50%; border:1px solid var(--n-200);
                                       background:#fff; cursor:pointer; display:flex; align-items:center; justify-content:center;
                                       box-shadow:0 2px 8px rgba(0,0,0,0.1);">
                                        <span class="material-symbols-outlined"
                                            style="font-size:1.25rem;">chevron_left</span>
                                    </button>

                                    <!-- Next arrow -->
                                    <button onclick="slideVehicles(1)" aria-label="Next" style="position:absolute; right:0; top:45%; transform:translateY(-50%); z-index:2;
                                       width:2.5rem; height:2.5rem; border-radius:50%; border:1px solid var(--n-200);
                                       background:#fff; cursor:pointer; display:flex; align-items:center; justify-content:center;
                                       box-shadow:0 2px 8px rgba(0,0,0,0.1);">
                                        <span class="material-symbols-outlined"
                                            style="font-size:1.25rem;">chevron_right</span>
                                    </button>
                                </div>

                                <!-- Dot indicators -->
                                <div id="sliderDots"
                                    style="display:flex; justify-content:center; gap:0.5rem; margin-top:1.25rem;"></div>

                                <div style="text-align:center; margin-top:1.5rem;">
                                    <a href="${pageContext.request.contextPath}/vehicles"
                                        class="btn btn-outline btn-lg">View All Vehicles</a>
                                </div>
                            </c:when>
                            <c:otherwise>
                                <div style="text-align:center; padding:3rem; color:var(--n-400);">
                                    <span class="material-symbols-outlined"
                                        style="font-size:3rem; display:block; margin-bottom:1rem;">directions_car</span>
                        ...
                        <div
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div style="display:flex; align-items:center; gap:0.75rem; margin-bottom:1rem;">
                                        <div
                                            style="width:40px; height:40px; border-radius:50%; background:var(--n-100); display:flex; align-items:center; justify-content:center; flex-shrink:0;">
                                            <span class="material-symbols-outlined"
                                                style="font-size:1.25rem; color:var(--n-400);">person</span>
                                        </div>
                                        <div>
                                            <p style="font-weight:700; font-size:0.9rem;">Aarav Sharma</p>
                                            <span
                                                style="color:#f59e0b; font-size:0.85rem;">&#9733;&#9733;&#9733;&#9733;&#9733;</span>
                                        </div>
                                    </div>
                                    <p style="font-size:0.875rem; color:var(--n-500); line-height:1.65;">
                                        Rented an SUV for a Pokhara trip — the booking process was seamless and the
                                        vehicle was spotless. Will definitely use Urban Drive again!
                                    </p>
                                </div>
                            </div>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <p style="font-size:0.875rem; color:var(--n-500); line-height:1.65;">
                                        Transparent pricing, no hidden fees, and the cancellation policy is fair.
                                        Finally a rental platform in Nepal that actually works well.
                                    </p>
                                </div>
                            </div>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <p style="font-size:0.875rem; color:var(--n-500); line-height:1.65;">
                                        Booked a sedan for a week-long road trip. Customer support was responsive and
                                        the handover was quick. Highly recommended service!
                                    </p>
                                </div>
                            </div>
                            ...
                            <div class="reviews-more-grid">
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <p style="font-size:0.875rem; color:var(--n-500); line-height:1.65;">
                                            First time renting a car in Nepal and it couldn't have been easier. The team
                                            was professional and the vehicle was in perfect condition throughout our
                                            Chitwan trip.
                                        </p>
                                    </div>
                                </div>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <p style="font-size:0.875rem; color:var(--n-500); line-height:1.65;">
                                            Used Urban Drive for a business trip from Kathmandu to Hetauda. On-time
                                            pickup, clean interior, and a hassle-free return. Will be my go-to rental
                                            service from now on.
                                        </p>
                                    </div>
                                </div>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <p style="font-size:0.875rem; color:var(--n-500); line-height:1.65;">
                                            The cancellation policy saved me when my plans changed last minute. Got a
                                            full refund with no drama at all. Genuinely impressed with how fair and
                                            transparent everything was.
                                        </p>
                                    </div>
                                </div>
                ...
                <section class="cta-section">
                    <div class="cta-box">
                        ...
                        <a href="${pageContext.request.contextPath}/register" class="btn btn-white btn-xl">Get Started
                            Free</a>
                    </div>
                </section>
            </main>
            ...
            <script>
                ...
                // Hero: reveal content 2 seconds before video ends
                (function () {
                    ...
                    video.addEventListener('timeupdate', function () {
                        if (!revealed && video.duration && video.currentTime >= video.duration - 7.7) {
                            revealed = true;
